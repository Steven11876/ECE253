...
TOCENTRE:	
	...
	MOVEQ    	R2, #1            // If yes, change the direction
	...
	LSL        R10, R10, #1
	AND        R11, R3, #0b1111100000    // Shift the left half once to the right
	ROR        R11, R11, #1
	ORR        R3, R10, R11        // Or together to get both LEDs to display
	//CMP R3, #0x30
	//BNE DONE_SWEEP
